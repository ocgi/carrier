	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CarrierV1alpha1().GameServerSets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CarrierV1alpha1().GameServerSets(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *gameServerSetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&carrierv1alpha1.GameServerSet{}, f.defaultInformer)
}
