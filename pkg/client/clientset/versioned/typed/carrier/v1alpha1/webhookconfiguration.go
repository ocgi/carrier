...
// WebhookConfigurationsGetter has a method to return a WebhookConfigurationInterface.
...
// webhookConfigurations implements WebhookConfigurationInterface
type webhookConfigurations struct {
	client rest.Interface
	ns     string
}

// newWebhookConfigurations returns a WebhookConfigurations
func newWebhookConfigurations(c *CarrierV1alpha1Client, namespace string) *webhookConfigurations {
...
func (c *webhookConfigurations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.WebhookConfigurationList, err error) {
	...
	result = &v1alpha1.WebhookConfigurationList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("webhookconfigurations").
