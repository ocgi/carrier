...
import (
	...
	"github.com/ocgi/carrier/pkg/client/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type CarrierV1alpha1Interface interface {
	RESTClient() rest.Interface
	GameServersGetter
	GameServerSetsGetter
	SquadsGetter
	WebhookConfigurationsGetter
}
...
// NewForConfigAndClient creates a new CarrierV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*CarrierV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
	...
	return &CarrierV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new CarrierV1alpha1Client for the given config and
...
func New(c rest.Interface) *CarrierV1alpha1Client {
	return &CarrierV1alpha1Client{c}
}
