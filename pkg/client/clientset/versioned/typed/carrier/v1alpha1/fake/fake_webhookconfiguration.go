...
var webhookconfigurationsResource = schema.GroupVersionResource{Group: "carrier.ocgi.dev", Version: "v1alpha1", Resource: "webhookconfigurations"}
...
func (c *FakeWebhookConfigurations) Get(name string, options v1.GetOptions) (result *v1alpha1.WebhookConfiguration, err error) {
	...
	return obj.(*v1alpha1.WebhookConfiguration), err
}
...
func (c *FakeWebhookConfigurations) List(opts v1.ListOptions) (result *v1alpha1.WebhookConfigurationList, err error) {
	...
	list := &v1alpha1.WebhookConfigurationList{ListMeta: obj.(*v1alpha1.WebhookConfigurationList).ListMeta}
	for _, item := range obj.(*v1alpha1.WebhookConfigurationList).Items {
