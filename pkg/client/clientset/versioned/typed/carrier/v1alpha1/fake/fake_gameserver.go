...
var gameserversResource = schema.GroupVersionResource{Group: "carrier.ocgi.dev", Version: "v1alpha1", Resource: "gameservers"}

var gameserversKind = schema.GroupVersionKind{Group: "carrier.ocgi.dev", Version: "v1alpha1", Kind: "GameServer"}
