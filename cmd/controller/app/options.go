...
func (s *RunOptions) addControllerFlags() {
	pflag.StringVar(&s.SidecarImage, "sidecar-image", "", "sidecar image name.")
	pflag.BoolVar(&s.AlwaysPullSidecarImage, "always-pull-sidecarimage", true, "if need always pull sidecar image.")
	pflag.StringVar(&s.SidecarCPU, "sidecar-cpu", "100m", "sidecar cpu.")
	pflag.StringVar(&s.SidecarMemory, "sidecar-memory", "100M", "sidecar memory.")
	pflag.StringVar(&s.SDKServiceAccount, "sdk-serviceaccount", "default", "service account name.")
